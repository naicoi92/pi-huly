...
// interop (giống makeCollabId T-103) → createRequire. Trả hex 24 ký tự, match
// doc thật + huly-mcp (KHÔNG dùng `${DOCUMENT_CLASS}.<rand>` class-prefix — id
// hex là convention Huly).
