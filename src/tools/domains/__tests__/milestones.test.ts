// Test T-51 #41 + T-52 #42 cho milestones domain.
// T-51: create_milestone project-null → isError.
// T-52: set_issue_milestone milestone FK validate.
...
describe("T-51 #41: create_milestone project space resolve (no silent fallback)", () => {
  ...
  it("project exists → createDoc dùng project.space (KHÔNG fallback workspace)", async () => {
    ...
    expect(call?.[1]).toBe("proj-space-xyz");
