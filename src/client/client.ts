...
// T-103 #156 → fix interop: makeCollabId (core) + jsonToMarkup (text-core) exist
// runtime nhưng KHÔNG trong .d.ts. @hcengineering/core là CJS, và 2 cách import
// ESM đều gãy ở 1 môi trường: default import (`import core`) → core.makeCollabId
// undefined dưới vitest; namespace (`import * as core`) → undefined dưới plain
// Node/dist. createRequire(import.meta.url) trả module.exports nguyên thẳng
// → đúng ở CẢ vitest lẫn production/dist. (textCore/textMarkdown default import
// hiện work ở cả 2 môi trường do cấu trúc CJS khác — để nguyên, surgical.)
